...
import { getTestimonialsContent, saveTestimonialsContent, type TestimonialsContent } from "@/lib/cms-store";
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const result = await saveTestimonialsContent(body.content);
    if (!result.ok) {
