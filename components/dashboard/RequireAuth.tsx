...
export default function RequireAuth({ children }: { children: ReactNode }) {
  ...
  // Role enforcement once the session has resolved. If the cookie
  // exists but the session reports a different role, bounce.
  useEffect(() => {
    ...
    // If no cookie but session says authenticated, or cookie present
    // but not yet resolved, do nothing — we render children already.
